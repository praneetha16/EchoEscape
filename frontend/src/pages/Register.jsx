...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-10 relative overflow-hidden"
      ...
      {/* Background blobs */}
      <div className="absolute top-[-20%] right-[-10%] w-[500px] h-[500px] rounded-full pointer-events-none blob2"
        style={{ background: "rgba(139,92,246,0.10)", filter: "blur(120px)" }} />
      <div className="absolute bottom-[-15%] left-[-10%] w-[400px] h-[400px] rounded-full pointer-events-none blob1"
        style={{ background: "rgba(0,229,255,0.10)", filter: "blur(110px)" }} />
      ...
      <motion.div initial={{ opacity:0, y:28 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.5 }}
        ...
        <div className="rounded-3xl overflow-hidden"
          style={{
            ...
            boxShadow: "0 0 60px rgba(139,92,246,0.08), 0 40px 80px rgba(0,0,0,0.5)",
          ...
          <form onSubmit={handleSubmit} className="px-8 py-7 space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold mb-2 tracking-widest uppercase"
                style={{ color:"rgba(0,229,255,0.7)" }}>Confirm Password</label>
          ...
          <div className="px-8 pb-7 text-center">
            <p style={{ color:"rgba(255,255,255,0.35)", fontSize:"0.875rem" }}>
              ...
              <Link to="/login" className="font-bold transition-colors" style={{ color:"#00E5FF" }}>
                Sign In
              </Link>
            </p>
          </div>
